...
if [ -z "$api_key" ]; then
    echo ""
    echo "🔑 Please enter your Moonshot  API Key｜设置你的 Moonshot API Key:"
    echo "   You can get your API Key from｜可访问右边地址获取 API Key: https://platform.moonshot.cn/console/api-keys"
